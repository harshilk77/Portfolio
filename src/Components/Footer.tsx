...
const Footer=()=>{
    ...
    return <div className="mt-20 mb-10 font-mono flex flex-col gap-2 items-center">
        ...
        <div className="md-mx:flex hidden text-black gap-8 sm-mx:gap-6">{socialIcons}</div>
        <div className="text-black text-xl md-mx:text-lg sm-mx:text-base xs-mx:text-sm xs-mx:flex flex-col items-center">Copyright &copy; {new Date().getFullYear()} {Info.name} <span className="xs-mx:hidden">|</span> <span>All Rights Reserved</span></div>
    </div>
}
