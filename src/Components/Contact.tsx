...
const Contact = () => {
    ...
    return <div className="px-16 md-mx:px-8 sm-mx:px-4 mx-20 lg-mx:mx-10 md-mx:mx-0   my-10  font-mono" id="Contact">
        <h1 className="text-4xl  sm-mx:text-3xl xs-mx:text-2xl mb-10 font-bold text-center text-black">
    Contact</h1>
        <div data-aos="flip-left" data-aos-duration="800" className="w-[70%] lg-mx:w-full shadow-[0_0_10px_0_#00000050] m-auto flex flex-col gap-6 border border-primaryColor p-8 rounded-3xl sm-mx:p-4">
            ...
            <Button fullWidth onClick={handleSubmit} rightSection={<IconArrowRight size={20} />}
                className="text-white !font-bold " variant="filled" size={btn} radius="lg" color="#000000FF">Send</Button>
        </div>
    </div>
}
